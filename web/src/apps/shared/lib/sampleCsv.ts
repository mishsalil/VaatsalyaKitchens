 ...
 *                   a "Group=" prefix starts a new choice group (the first
 *                   group defaults to Preparation), e.g.
 *                   "Preparation=Half:-70|Full:*+150|Vegetables=With:*0|Without:0"
...
export function sampleMenuCsv(): string {
  const rows = [
    { category: 'Starters', subcategory: 'Veg', item: 'Paneer Tikka', price: 350, unit: 'per plate', available: 'yes', variants: 'Preparation=Half:-70|Full:*+150', addons: 'Cheese:40|Cashews:60' },
    { category: 'Starters', subcategory: 'Veg', item: 'Hara Bhara Kabab', price: 280, unit: 'per plate', available: 'yes', variants: '', addons: '' },
    { category: 'Starters', subcategory: 'Non-Veg', item: 'Chicken 65', price: 320, unit: 'per plate', available: 'yes', variants: 'Preparation=Half:-80|Full:*+120', addons: '' },
